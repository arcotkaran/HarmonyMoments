...
const OCCASIONS = [
  {
    ...
    title: 'Romantic Picnic Date Night Sydney | Styled Setups from $250',
    description: 'Planning a romantic date night in Sydney? We style low-table picnics for two at golden hour — set up before you arrive, packed down after. From $250. 5.0 on Google.',
    price: 'From $250',
    ...
    priceSchema: '250',
    faqPrice: 'Date night setups start from <strong>$250</strong> for two, which covers the styled setting, florals and setup. Extras like fresh florals, additional d&eacute;cor and curated grazing sit on top.',
    faqPriceText: 'Date night setups start from $250 for two, which covers the styled setting, florals and setup. Extras like fresh florals, additional decor and curated grazing sit on top. Send us your date and we will come back with an exact quote.',
...

  {
    ...
    title: 'Anniversary Picnic Sydney | Styled Anniversary Setups from $250',
    description: 'Celebrating an anniversary in Sydney? We style romantic low-table picnics for two at golden hour — set up before you arrive, packed down after. From $250. 5.0 on Google.',
    price: 'From $250',
    priceNote: 'For two. Harbourside, beach, park or your own backyard.',
    ...
    priceSchema: '250',
    faqPrice: 'Anniversary setups start from <strong>$250</strong> for two, which covers the styled setting, florals and setup. Extras like a cake, additional fresh florals and curated grazing sit on top.',
    faqPriceText: 'Anniversary setups start from $250 for two, which covers the styled setting, florals and setup. Extras like a cake, additional fresh florals and curated grazing sit on top. Send us your date and we will come back with an exact quote.',
...

  {
    ...
    title: 'Birthday Picnic Sydney | Styled Birthday Setups from $250',
    description: 'Planning a birthday in Sydney? We style low-table birthday picnics for two or for groups of 4–6 — set up before you arrive, packed down after. From $250. 5.0 on Google.',
    price: 'From $250',
    priceNote: 'For two &middot; from <strong>$350</strong> for a group of 4&ndash;6. Harbourside, park or your own backyard.',
    ...
    priceSchema: '250',
    faqPrice: 'Birthday setups start from <strong>$250</strong> for two, or <strong>$350</strong> for a group of four to six. That covers the styled setting, florals and setup. Extras like a cake, balloons, additional florals and curated grazing sit on top.',
    faqPriceText: 'Birthday setups start from $250 for two, or $350 for a group of four to six. That covers the styled setting, florals and setup. Extras like a cake, balloons, additional florals and curated grazing sit on top. Send us your date and guest count and we will come back with an exact quote.',
...

  {
    ...
    title: 'Baby Shower Picnic Sydney | Styled Baby Shower Setups from $350',
    description: 'Planning a baby shower in Sydney? We style outdoor low-table setups for groups of 4–6 with pastel florals and balloon arches — set up and packed down for you. From $350.',
    price: 'From $350',
    ...
    priceSchema: '350',
    faqPrice: 'Baby shower setups start from <strong>$350</strong> for a group of four to six, which covers the styled setting, florals and setup. Extras like a balloon arch, dessert styling, additional florals and curated grazing sit on top.',
    faqPriceText: 'Baby shower setups start from $350 for a group of four to six, which covers the styled setting, florals and setup. Extras like a balloon arch, dessert styling, additional florals and curated grazing sit on top. Send us your date and guest count and we will come back with an exact quote.',
...

  {
    ...
    title: 'Bridal Shower Picnic Sydney | Styled Bridal Shower Setups from $350',
    description: 'Planning a bridal shower in Sydney? We style outdoor low-table setups for groups of 4–6 with white and blush florals — set up and packed down for you. From $350.',
    price: 'From $350',
    priceNote: 'For 4&ndash;6 guests. Harbourside, park or your own backyard.',
    ...
    priceSchema: '350',
    faqPrice: 'Bridal shower setups start from <strong>$350</strong> for a group of four to six, which covers the styled setting, florals and setup. Extras like a cake, signage, additional fresh florals and curated grazing sit on top.',
    faqPriceText: 'Bridal shower setups start from $350 for a group of four to six, which covers the styled setting, florals and setup. Extras like a cake, signage, additional fresh florals and curated grazing sit on top. Send us your date and guest count and we will come back with an exact quote.',
    ...
    <section class="testimonials section section-alt" id="reviews">
      <div class="container">
        ...
        <div class="review-grid">
          ...
          <figure class="review-card fade-in delay-2">
            <div class="review-stars" role="img" aria-label="Rated 5 out of 5 stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <blockquote class="review-quote">
              <p>We had the most amazing experience with Harmony Moments for a picnic set-up over the weekend, and I honestly couldn&rsquo;t recommend them highly enough! From start to finish, they were incredibly professional, organised and so lovely to deal with. The attention to detail was absolutely next level &mdash; every little element was beautifully thought through and perfectly styled.</p>
              <p>The whole set-up was even more beautiful than I imagined, and they truly went above and beyond to make everything feel so special. The team at Harmony Moments were amazing in every way, and I wouldn&rsquo;t hesitate to use them again.</p>
            </blockquote>
            <button type="button" class="review-more" aria-expanded="false">Read more</button>
            <figcaption class="review-meta"><span class="review-name">Michelle Mikelsen</span></figcaption>
          </figure>
          <figure class="review-card fade-in">
            <div class="review-stars" role="img" aria-label="Rated 5 out of 5 stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <blockquote class="review-quote">
              <p>I recently engaged Harmony Moments to organise a surprise picnic for my husband and children, and it was such a delightful experience from start to finish. From planning, coordinating through to the day of set up and picnic, everything was seamless, professional and stress-free.</p>
              <p>The set up itself was beautiful and immaculate, with every little detail thoughtfully taken care of. We simply turned up, without having to worry about a thing and were able to relax and enjoy the most beautiful family time together.</p>
            </blockquote>
            <button type="button" class="review-more" aria-expanded="false">Read more</button>
            <figcaption class="review-meta"><span class="review-name">Rachana Hegde</span></figcaption>
          </figure>
          <figure class="review-card fade-in delay-1">
            <div class="review-stars" role="img" aria-label="Rated 5 out of 5 stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <blockquote class="review-quote">
              <p>Harmony Moments and my wonderful wife and children presented an exceptional Father&rsquo;s Day picnic surprise for me. Every aspect was taken care of. A truly memorable day. Very grateful to Dipali and her team at HM.</p>
            </blockquote>
            <button type="button" class="review-more" aria-expanded="false">Read more</button>
            <figcaption class="review-meta"><span class="review-name">Kit Patel</span></figcaption>
          </figure>
        </div>
      </div>
    </section>
